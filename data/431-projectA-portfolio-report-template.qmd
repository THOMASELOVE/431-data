...
5. Make sure you've checked through the items in the Report Checklist before Submission that we list on the [Portfolio page](https://thomaselove.github.io/431-projectA-2024/portfolio.html).
...
Follow the instructions on the [Analyses page](https://thomaselove.github.io/431-projectA-2024/analyses.html) carefully.
...
Instead, follow the instructions on our [Portfolio page](https://thomaselove.github.io/431-projectA-2024/portfolio.html) to complete this section by writing a new paragraph (containing at least four well-constructed complete English sentences) to answer the following question:
